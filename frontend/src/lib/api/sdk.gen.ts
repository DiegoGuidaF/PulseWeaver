 ...
 *
 */
export const getPolicyMap = <ThrowOnError extends boolean = false>(options?: Options<GetPolicyMapData, ThrowOnError>) => (options?.client ?? client).get<GetPolicyMapResponses, GetPolicyMapErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        path: z.never().optional(),
        query: z.never().optional()
    }).parseAsync(data),
    responseValidator: async (data) => await zGetPolicyMapResponse.parseAsync(data),
    security: [{
            in: 'cookie',
            name: '__Host-wdc_session',
            type: 'apiKey'
 ...
 *
 */
export const simulatePolicyAccess = <ThrowOnError extends boolean = false>(options: Options<SimulatePolicyAccessData, ThrowOnError>) => (options.client ?? client).get<SimulatePolicyAccessResponses, SimulatePolicyAccessErrors, ThrowOnError>({
    requestValidator: async (data) => await z.object({
        body: z.never().optional(),
        path: z.never().optional(),
        query: zSimulatePolicyAccessQuery
    }).parseAsync(data),
    responseValidator: async (data) => await zSimulatePolicyAccessResponse.parseAsync(data),
    security: [{
            in: 'cookie',
            name: '__Host-wdc_session',
            type: 'apiKey'
