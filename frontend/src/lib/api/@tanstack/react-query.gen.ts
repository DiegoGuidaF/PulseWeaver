...
import type {
  ...
  GetAddressHistoryTuningError,
  GetAddressHistoryTuningResponse,
  GetCurrentUserData,
  GetCurrentUserError,
...
export const getAddressHistoryTuningQueryKey = (
  options?: Options<GetAddressHistoryTuningData>,
) => createQueryKey("getAddressHistoryTuning", options);
 ...
 *
 */
export const getAddressHistoryTuningOptions = (
  options?: Options<GetAddressHistoryTuningData>,
) =>
  queryOptions<
    GetAddressHistoryTuningResponse,
    GetAddressHistoryTuningError,
    GetAddressHistoryTuningResponse,
    ReturnType<typeof getAddressHistoryTuningQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await getAddressHistoryTuning({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: getAddressHistoryTuningQueryKey(options),
  });
