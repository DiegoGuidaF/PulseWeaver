...
CREATE TABLE pending_registrations_with_owner (
    id                          TEXT     PRIMARY KEY,
...
INSERT INTO pending_registrations_with_owner
SELECT id, device_name, 1, registration_code, device_api_key, device_api_key_prefix,
...
ALTER TABLE pending_registrations_with_owner RENAME TO pending_registrations;
